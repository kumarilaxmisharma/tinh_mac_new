    ...
    <>
      ...
      <div className="relative">
        <video class="w-full" autoplay muted controls>
          <source src="/images/macbook_air/large_2x.mp4" type="video/mp4"/>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-20">
          <div className="grid gap-4">
            <div>
              <img
                ...
                src="/images/macbook_air/design_top_starlight.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/design_magsafe_midnight.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/design_portability_1.jpg"
                alt=""
              />
            </div>
          </div>
          <div className="grid gap-4">
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/connectivity_displays.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/design_top_silver.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/apps.png"
                alt=""
              />
            </div>
          </div>
          <div className="grid gap-4">
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/design_top_midnight.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                ...
                src="/images/macbook_air/design_portability_2.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/mac_iphone__n2863l0ne0q6_large_2x.jpg"
                alt=""
              />
            </div>
          </div>
          <div className="grid gap-4">
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/touch id.png"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/design_top_skyblue.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/macbook_air/design_portability_3.jpg"
                alt=""
              />
            </div>
          </div>
